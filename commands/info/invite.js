  ...
  run: async (client, message, args, user, text, prefix) => {
    return message.reply(
      new Discord.MessageEmbed()
          .setAuthor(`Invite the Bot`, config.AVATARURL)
          .setColor("#91bfff")
          .setFooter(client.user.username, config.AVATARURL)  
          .setDescription(`[\`CLICK HERE\`](https://discord.com/api/oauth2/authorize?client_id=878669298711801926&permissions=8&scope=bot)`)
  )
    }
}
