...
client.on("message", async message => {
    ...
    client.settings.ensure(message.guild.id, {
      ...
      channel: "",
      command: "feedback",
      approvemsg: "<:Accepted:864080263172718603> Accepted Idea! Expect this soon.",
      denymsg: "<:Decline:864080227738320896> Thank you for the feedback, but we are not interested in this idea at this time.",
      ...
      approveemoji: "<:Accepted:864080263172718603>",
      denyemoji: "<:Decline:864080227738320896>",
      role: "",
      });
    ...
    if (message.content.includes(client.user.id)) { //if message contains musicium as a ping
       return message.reply(new Discord.MessageEmbed().setColor("#91bfff").setAuthor(`${message.author.username}, My Prefix is ${prefix}, to get started; type ${prefix}help`, message.author.displayAvatarURL({ dynamic: true }), "https://su.musicium.eu"));
    }
    ...
    if (command) //if the command is now valid
    {
      ...
      try{
        ...
        HERE AN EXAMPLE:
            ...
            User: RByxle#9999   types command:
