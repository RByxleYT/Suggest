      ...
      switch(args[1]){
        case "approve":
          ...
          await message.channel.send(
            new MessageEmbed()
              .setColor("45BB8A")
              .setTitle(`**<:Accepted:864080263172718603> | Suggestion got approved!**`)
        ...
        case "deny":
          ...
          await message.channel.send(
            new MessageEmbed()
              .setColor("EF4949")
              .setTitle(`**<:Accepted:864080263172718603> | Suggestion got declined!**`)
              .setDescription(`${channel}`)
          );
        break;
        ...
        case "maybe":
          ...
          await message.channel.send(
            new MessageEmbed()
              .setColor("#91bfff")
              .setTitle(`**<:Accepted:864080263172718603> | Suggestion got "maybed"!**`)
              .setDescription(`${channel}`)
          );
          break;
